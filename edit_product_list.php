...
<div class="container text-center">
    ...
    <div class="row">
        ...
        ?>
            <div class="col-sm-4">
               <a href="./edit_product.php?id=<?=$item['product_id']?>"> <img src="<?php echo "../DoAnMaNguonMo/" . $item["productPicture"]; ?>" class="img-responsive" style="width: 100%;" alt="Image"></a>
                <p class="text-danger"><?php echo $item["productName"]; ?></p>
                <p class="text-info"><?php echo number_format($item["price"], 0, ",", ".") ?> VND</p>
                <p>
                    <!-- <button type="button" class="btn btn-primary" onclick="location.href='../DA_manguonmo/edit_product.php?id=<?php echo $item["product_id"]; ?> '">Mua Hoa </button> -->
                </p>
            </div>
        <?php } ?>
    </div>
